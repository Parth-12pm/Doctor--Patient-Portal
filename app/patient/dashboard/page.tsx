...
import { Calendar, User, Clock, AlertCircle, Plus, Activity, Heart, Phone } from "lucide-react"
      ...
      <div className="container mx-auto p-6">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Welcome back, {profile?.name || session?.user?.email}</p>
          </div>
          ...
          <Card className="mb-6 border-orange-200 bg-orange-50">
            <CardContent className="flex items-center gap-3 pt-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-orange-700 text-sm">Please complete your medical profile to book appointments</p>
              </div>
                      ...
                      <div key={appointment._id} className="flex items-center justify-between p-4 border rounded-lg">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">{appointment.doctorId.speciality}</p>
